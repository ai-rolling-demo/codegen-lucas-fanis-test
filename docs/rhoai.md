...
3) Access the `workbench` named `codegen-lucas-fanis-test-notebook`.
...
5) In the terminal, run `cd codegen-lucas-fanis-test` to navigate to your sample app's directory.

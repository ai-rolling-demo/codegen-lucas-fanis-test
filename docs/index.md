...
!!! info
    ...
    **Source Code Repository:** [https://github.com/ai-rolling-demo/codegen-lucas-fanis-test](https://github.com/ai-rolling-demo/codegen-lucas-fanis-test)

    **GitOps Repository:** [https://github.com/ai-rolling-demo/codegen-lucas-fanis-test-gitops](https://github.com/ai-rolling-demo/codegen-lucas-fanis-test-gitops)

# **Usage**

To access the codegen-lucas-fanis-test application that was deployed using the Software Template, complete the following instructions:
